<?php /* Smarty version 2.6.18, created on 2012-03-28 13:43:10
...
<fieldset>
    ...
    <dl>
        ...
        <dd>
            <input type="text" name="num_posts" value="<?php echo $this->_tpl_vars['fp']->num_posts; ?>
" />
        </dd>
        ...
        <dd>
            <select name="blog_public">
                <option value="0"
                  <?php if (! $this->_tpl_vars['fp']->blog_public): ?> selected="selected"<?php endif; ?>>No</option>

                <option value="1"
                  <?php if ($this->_tpl_vars['fp']->blog_public): ?> selected="selected"<?php endif; ?>>Yes</option>
            </select>
        </dd>
    </dl>
</fieldset>
