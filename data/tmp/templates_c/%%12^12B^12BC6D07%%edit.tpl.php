<?php /* Smarty version 2.6.18, created on 2012-04-05 21:05:34
         compiled from blogmanager/edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'geturl', 'blogmanager/edit.tpl', 10, false),array('function', 'html_select_date', 'blogmanager/edit.tpl', 33, false),array('function', 'html_select_time', 'blogmanager/edit.tpl', 38, false),array('function', 'wysiwyg', 'blogmanager/edit.tpl', 48, false),array('modifier', 'escape', 'blogmanager/edit.tpl', 26, false),)), $this); ?>
...
<div class="submit">
    ...
    <input onclick="GetContents();" type="submit" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
    <?php if (! $this->_tpl_vars['fp']->post->isLive()): ?>
        <input onclick="GetContents();" type="submit" name="preview" value="Preview This Post" />
    <?php endif; ?>
</div>
