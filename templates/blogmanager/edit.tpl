...
<div class="submit">
    ...
    <input onsubmit="javascript:GetContents();" type="submit" value="{$label|escape}" />
    {if !$fp->post->isLive()}
        <input onsubmit="javascript:GetContents();" type="submit" name="preview" value="Preview This Post" />
    {/if}
</div>
